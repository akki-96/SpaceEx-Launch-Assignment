...
export default function App() {
  ...
  const apiCall = async () => {
    ...
    //console.log(apiJsonData[0].links.patch.small);
  ...
  return (
    <div className="App">
      <h1 className="heading">SpaceEx Launch Programs</h1>
          ...
          <div className="rightGrid">
            <div className="card">
              ...
              <div className="container">
                <h4>Mission Ids :</h4> <br />
                <h4>Launch Year :</h4> <br />
                <h4>Successful Launch :</h4> <br />
                <h4>Successful Landing :</h4> <br />
              </div>
            </div>
          </div>
        </div>
